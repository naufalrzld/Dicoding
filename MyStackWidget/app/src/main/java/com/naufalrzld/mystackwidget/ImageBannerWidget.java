package com.naufalrzld.mystackwidget;
...
public class ImageBannerWidget extends AppWidgetProvider {
    public static final String TOAST_ACTION = "com.naufalrzld.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.naufalrzld.EXTRA_ITEM";
